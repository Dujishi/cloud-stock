...
//将连接符的单词组转为驼峰单词组
String.prototype.toHumpWords = function(hyphen) {
	hyphen = hyphen || "_"; // 默认为下划线
	var reg = new RegExp(hyphen + "(\\w)", "g");
	return this.replace(reg, function(all, letter){
		return letter.toUpperCase();
	});
}
//将驼峰单词组转为连接符单词组
String.prototype.toHyphenWords = function(hyphen) {
	hyphen = hyphen || "_"; // 默认为下划线
