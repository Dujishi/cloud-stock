...
// The accordion directive simply sets up the directive web
...
.directive('accordionHeading', function() {
  return {
    ...
    link: function(scope, element, attr, accordionGroupCtrl, transclude) {
      // Pass the heading to the accordion-group web
...
// You must provide the property on the accordion-group web that will hold the transcluded element
...
.directive('tab', ['$parse', '$log', function($parse, $log) {
  return {
    ...
    controller: function() {
      //Empty web so other directives can require being 'under' a tab
    },
