package com.xiaoka.cloud.stock.service.server.core.parser.erp;
 ...
 */
@Service
public class RongyiErpParser implements HtmlParser<String> {
	...
	public static RongyiStockDto buildRongyiStockBy(Elements tds) {
