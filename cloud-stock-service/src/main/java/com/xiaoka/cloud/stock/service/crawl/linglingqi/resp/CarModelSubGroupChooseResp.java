 ...
 * Do something
 *
 * @author gancao 2017/12/18 19:59
 * @see [相关类/方法]
 * @since [版本号]
 */
public class CarModelSubGroupChooseResp implements Serializable {

	private static final long serialVersionUID = -1723821558878956318L;
