...
/**
 * 实体CarModelDto被占用，使用CarModelWebDto作为web层返回结果集
 * @author suqin
 * @date 2017/11/29
 */
public class CarModelWebDto implements Serializable {

	private static final long serialVersionUID = -7305291536634916177L;
